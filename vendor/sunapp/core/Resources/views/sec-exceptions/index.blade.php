                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-body">
                        ...
                        <div class="sg-app-area">
                                                        ...
                                                        <div class="user-details">
                                                            <div class="mail-items">
                                                                ...
                                                                <span class="form-group-translation">
                                                                    ...
                                                                    <span>@{{ item.attributes.status_code }} (@{{ item.attributes.exception_type }})</span>
                                                                    <span>@lang('core::security.ip_address'): @{{ item.attributes.ip_address }}</span>
                                                                </span>
                                                                </h5>
                                                                <div><b>@lang('core::security.created_at'):</b> @{{ item.attributes.created_at }}</div>
                                                                <div><b>@lang('core::security.url'):</b> @{{ item.attributes.url }}</div>
                            ...
                            @include('core::sec-exceptions.form')
                        </div>
                    </div>
                </div>
            </div>
...
@theme_asset('roles-vue', '../modules/core/assets/js/sec-exceptions.js', ['base-vue'])
