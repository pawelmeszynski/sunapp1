...
@section('template_title')
    @lang('modules.installation') "{{$package_name}}"
@endsection
...
@section('container')
    ...
    @endphp
    @if($installed)
        <p><strong>@lang('modules.installed')</strong></p>
        @if($url!=URL::current())
            <div class="buttons">
    ...
    @else
        ...
        <div id="app">
            ...
            <div id="finish" style="display: none;">
                <p><strong>@lang('modules.installation_completed')</strong></p>
            </div>
        </div>
    @endif
        ...
        var app = new Vue({
            ...
            methods: {
                run: function () {
                    ...
                    var streamUrl = '{{route('SunAppModules::install',['package'=>$package,'url'=>$url])}}';
