        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="{{ env('APP_NAME','SunApp') }}"
                ...
                <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }}">
                    ...
                    <select name="environment" id="environment" onchange='checkEnvironment(this.value);'>
                        <option value="local"
                                @if(env('APP_ENV','local')=='local') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_environment_label_local') }}</option>
                        <option value="development"
                                @if(env('APP_ENV','local')=='development') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_environment_label_developement') }}</option>
                        <option value="qa"
                                @if(env('APP_ENV','local')=='qa') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_environment_label_qa') }}</option>
                        <option value="production"
                                @if(env('APP_ENV','local')=='production') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_environment_label_production') }}</option>
                        <option value="other"
                                @if(env('APP_ENV','local')!='local' && env('APP_ENV','local')!='development' && env('APP_ENV','local')!='qa' && env('APP_ENV','local')!='production') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_environment_label_other') }}</option>
                    </select>
                    <div id="environment_text_input" style="display: none;">
                        <input type="text" name="environment_custom" id="environment_custom"
                               @if(env('APP_ENV','local')!='local' && env('APP_ENV','local')!='development' && env('APP_ENV','local')!='qa' && env('APP_ENV','local')!='production') value="{{ env('APP_ENV') }}"
                               @endif placeholder="{{ trans('installer_messages.environment.wizard.form.app_environment_placeholder_other') }}"/>
                    </div>
                ...
                <div class="form-group {{ $errors->has('app_debug') ? ' has-error ' : '' }}">
                    ...
                    <label for="app_debug_true">
                        <input type="radio" name="app_debug" id="app_debug_true" value=true
                               @if(env('APP_DEBUG',true)==true) checked @endif/>
                    ...
                    <label for="app_debug_false">
                        <input type="radio" name="app_debug" id="app_debug_false" value=false
                               @if(env('APP_DEBUG',true)==false) checked @endif/>
                ...
                <div class="form-group {{ $errors->has('app_log_level') ? ' has-error ' : '' }}">
                    ...
                    <select name="app_log_level" id="app_log_level">
                        <option value="debug"
                                @if(env('APP_LOG_LEVEL','debug')=='debug') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_log_level_label_debug') }}</option>
                        <option value="info"
                                @if(env('APP_LOG_LEVEL','debug')=='info') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_log_level_label_info') }}</option>
                        <option value="notice"
                                @if(env('APP_LOG_LEVEL','debug')=='notice') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_log_level_label_notice') }}</option>
                        <option value="warning"
                                @if(env('APP_LOG_LEVEL','debug')=='warning') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_log_level_label_warning') }}</option>
                        <option value="error"
                                @if(env('APP_LOG_LEVEL','debug')=='error') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_log_level_label_error') }}</option>
                        <option value="critical"
                                @if(env('APP_LOG_LEVEL','debug')=='critical') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_log_level_label_critical') }}</option>
                        <option value="alert"
                                @if(env('APP_LOG_LEVEL','debug')=='alert') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_log_level_label_alert') }}</option>
                        <option value="emergency"
                                @if(env('APP_LOG_LEVEL','debug')=='emergency') selected @endif>{{ trans('installer_messages.environment.wizard.form.app_log_level_label_emergency') }}</option>
                    </select>
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{ env('APP_URL','http://localhost') }}"
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_connection') ? ' has-error ' : '' }}">
                    ...
                    <select name="database_connection" id="database_connection">
                        <option value="mysql"
                                @if(env('DB_CONNECTION','mysql')=='mysql') selected @endif>{{ trans('installer_messages.environment.wizard.form.db_connection_label_mysql') }}</option>
                        <option value="sqlite"
                                @if(env('DB_CONNECTION','mysql')=='sqlite') selected @endif>{{ trans('installer_messages.environment.wizard.form.db_connection_label_sqlite') }}</option>
                        <option value="pgsql"
                                @if(env('DB_CONNECTION','mysql')=='pgsql') selected @endif>{{ trans('installer_messages.environment.wizard.form.db_connection_label_pgsql') }}</option>
                        <option value="sqlsrv"
                                @if(env('DB_CONNECTION','mysql')=='sqlsrv') selected @endif>{{ trans('installer_messages.environment.wizard.form.db_connection_label_sqlsrv') }}</option>
                    </select>
                ...
                <div class="block">
                    ...
                    <div class="info">
                        ...
                        <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                            ...
                            <input type="number" name="mail_port" id="mail_port" value="{{ env('MAIL_PORT','2525') }}"
