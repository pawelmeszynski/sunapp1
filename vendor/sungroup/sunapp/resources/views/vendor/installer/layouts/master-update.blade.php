...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ mix('images/favicon/favicon-16x16.png','installer') }}" sizes="16x16"/>
    <link rel="icon" type="image/png" href="{{ mix('images/favicon/favicon-32x32.png','installer') }}" sizes="32x32"/>
    <link rel="icon" type="image/png" href="{{ mix('images/favicon/favicon-96x96.png','installer') }}" sizes="96x96"/>
    <link href="{{ mix('css/style.min.css','installer') }}" rel="stylesheet"/>
    @yield('style')
    <script>
