...
namespace SunGroup\Composer\Merge;

use SunGroup\Composer\Logger;
...
class ExtraPackage
{
    ...
    /**
     * Get list of Laravel configurations.
     *
     * @return array|bool
     */
    public function getLaravel()
    {
        return isset($this->json['extra']['laravel']) ?
            $this->json['extra']['laravel'] : false;
    }
    ...
    protected function mergeConstraints(Link $origin, Link $merge, PluginState $state)
    {
        ...
        if ($state->isComposer1()) {
            $constraintClass = 'SunGroup\\Composer\\Merge\\MultiConstraint';
        } else {
