...
use SunAppModules\SunBet\Providers\SunBetServiceProvider;
...
class SocialiteManager extends Manager implements Contracts\Factory
{
    ...
    protected function createSunBetDriver()
    {
        $config = $this->config->get('services.sunbet');

        return $this->buildProvider(
            SunBetServiceProvider::class, $config
        );
    }
