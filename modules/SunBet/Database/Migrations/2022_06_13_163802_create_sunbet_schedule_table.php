...
class CreateSunbetScheduleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sunbet_schedules', function (Blueprint $table) {
...
//            $table->foreign('home_team_id')->references('id')->on('competitions');
//            $table->foreign('away_team_id')->references('id')->on('competitions');
        });
    }
