                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-body">
                        ...
                        <div class="sg-app-area">
                                        ...
                                        <div class="action-right">
                                            <ul class="list-inline m-0">
                                                <li id="list-inline-item--remove" class="list-inline-item hidden">
                                                    <a href="#" class="action-icon remove-all has-tooltip"
                                                       @click.prevent="removeAll">
                                                        <span
                                                            class="tooltip-text">@lang('core::actions.remove_selected')</span>
                                                        <i class="feather icon-trash"></i>
                                                    </a>
                                                </li>
                                                <li id="list-inline-item--restore" class="list-inline-item hidden">
                                                    <a href="#" class="action-icon restore-all has-tooltip"
                                                       @click.prevent="restoreAll">
                                                        <span
                                                            class="tooltip-text">@lang('core::actions.restore_selected')</span>
                                                        <i class="feather icon-arrow-left"></i>
                                                    </a>
                                                </li>
                                                <li v-if="userCanCreate && createUrl" class="list-inline-item">
                                                    <a :href="createUrl" @click.prevent="createElement('click')"
                                                       class="has-tooltip">
                                                        <span
                                                            class="tooltip-text">@lang('core::actions.new_item')</span>
                                                        <span class="action-icon"><i
                                                                class="feather icon-plus"></i></span>
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                    <a class="dt-refresh-action has-tooltip" href="#"
                                                       @click.prevent="getItems('refresh', searchPhrase)">
                                                        <span
                                                            class="tooltip-text">@lang('core::actions.refresh_list')</span>
                                                        <span class="action-icon"><i
                                                                class="feather icon-refresh-ccw"></i></span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                                    ...
                                                    <div class="media-body">
                                                        <div class="user-details">
                                                            <div class="mail-items">
                                                                ...
                                                                <span class="form-group-translation">
                                                                    ...
                                                                    <span class="text-muted"> @{{ item.attributes.name }}</span>
                                                                    <a href="@{{ item.attributes.crest }}">
                                                                    <span class="form-field-translation d-inline-block">
                                                                        @{{ item.attributes.ip_address_mask }}
                                                                    </span>
                                                                </span>
                                                                </h5>
                                                                <span class="list-group-item-text text-truncate">@lang('core::fields.last_update'): @{{ item.attributes.updated_at }}<template
                                                                        v-if="item.attributes.updatedBy">, @{{ item.attributes.updatedBy }}</template>
                                                                </span>
                                                            </div>
                                                            <div class="mail-meta-item">
                                                                <div class="float-right">
                                                                    <div class="float-right todo-item-action d-flex">
                                                                        <template
                                                                            v-if="item.links.update && item.attributes.deleted_at">
                                                                            <a class="has-tooltip has-tooltip--down"
                                                                               :href="item.links.update"
                                                                               @click.prevent="restoreElement($event)">
                                                                                <span
                                                                                    class="tooltip-text">@lang('core::actions.restore')</span>
                                                                                <i class="m-25 feather icon-arrow-left"></i>
                                                                            </a>
                                                                            <form :action="item.links.update"
                                                        ...
                                                        <div class="mail-message">
                                                            ...
                                                            <div class="chip-wrapper d-inline-block"
                                                                 v-if="item.attributes.w_2fa">
                                                                <div class="chip chip-success mb-0">
                                                                    <div class="chip-body">
                                                                        <span
                                                                            class="chip-text"> @lang('core::access.no_check_w_2fa')</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            </template>
                            ...
                            @include('sunbet::competitions.form')
                        </div>
                    </div>
                </div>
            </div>
...
@theme_asset('access-vue', '../modules/sunbet/assets/js/competitions.js', ['base-vue'])
